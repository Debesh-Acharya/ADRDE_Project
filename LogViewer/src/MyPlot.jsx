  ...
  return (
    <div className="flex flex-col items-start w-full h-full relative">
      ...
      <CSSTransition
        ...
        unmountOnExit
      >
        <div className="fixed left-0 top-16 h-full w-72 bg-dark p-4 z-20 sidebar overflow-y-auto">
          <button
  ...
  return (
    <div className="mb-8 p-4 border border-gray-300 rounded bg-gray-700 text-white">
      ...
      <div className="mb-4">
        ...
        >
          {csvData && Object.keys(csvData[0]).map((column) => (
      ...
      {selectedYColumns.map((yColumn, index) => (
        <div key={index} className="mb-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <label htmlFor={`scalingFactor${id}-${index}`} className="mr-2">
              Scaling Factor:
            </label>
            <input
          ...
          <div className="flex items-center justify-between mt-2">
            <label htmlFor={`offset${id}-${index}`} className="mr-2">
              Offset:
            </label>
            <input
              id={`offset${id}-${index}`}
